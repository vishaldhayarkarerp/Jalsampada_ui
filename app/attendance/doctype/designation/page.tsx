...
export default function DesignationListPage() {
  ...
  const handleCardClick = (id: string) => {
    router.push(
      `/attendance/doctype/designation/${encodeURIComponent(id)}`
    );
  };

  const getFieldsForRecord = (record: Designation): RecordCardField[] => [
    {
      label: "Designation",
  ...
  if (loading) return <p style={{ padding: "2rem" }}>Loading Designations...</p>;
      ...
      <div className="module-header">
        ...
        {selectedIds.size > 0 ? (
          ...
          <button
            ...
            onClick={() =>
              router.push("/attendance/doctype/designation/new")
            }
          >
