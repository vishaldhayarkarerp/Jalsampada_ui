...
export default function WorkSubtypeDetailPage() {
  ...
  const [record, setRecord] = React.useState<WorkSubtype | null>(null);
  ...
  React.useEffect(() => {
    const fetchRecord = async () => {
      ...
      try {
        ...
        const resp = await axios.get(`${API_BASE_URL}/Work Subtype/${recordId}`, {
          headers: {
  ...
  return (
    <div className="module active">
      <div className="module-header">
        <div>
          <h2>Work Subtype - {record.name}</h2>
