...
export default function DraftTenderPaperDetailPage() {
  ...
  const [record, setRecord] = React.useState<DraftTenderPaper | null>(null);
  ...
  React.useEffect(() => {
    const fetchRecord = async () => {
      ...
      try {
        ...
        const resp = await axios.get(`${API_BASE_URL}/Draft Tender Paper/${recordId}`, {
          headers: {
  ...
  return (
    <div className="module active">
      <div className="module-header">
        <div>
          <h2>Draft Tender Paper - {record.name}</h2>
