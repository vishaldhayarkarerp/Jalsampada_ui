...
// Use the RHF-powered DynamicForm template. It uses only styles from globals.css and assets.css
// so the UI stays consistent. See comments inside the component for how fields are styled.
...
export default function RecordDetailPage() {
  ...
  // Note: Validation is declared in each field and consumed by react-hook-form in DynamicForm.
  // - required: shows a red error message below the control using .text-error
  // - min/max: numeric bounds
  // - pattern: regex validation for strings (see asset_id example)
  const formFields: FormField[] = [
    ...
    },
    {
      ...
      description: "Unique barcode identifier (A–Z, 0–9, dash/underscore)",
      // Example of pattern validation: uppercase letters, numbers, - and _ only
      pattern: "^[A-Z0-9_-]+$",
      patternMessage: "Only A–Z, 0–9, dash (-) and underscore (_) are allowed"
    },
    {
      name: "category",
      label: "Category",
