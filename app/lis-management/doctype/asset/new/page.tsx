...
export default function NewRecordPage() {
  ...
  const formTabs: TabbedLayout[] = [
    ...
    },
    {
      name: "Depreciation",
      fields: [
        { name: "calculate_depreciation", label: "Calculate Depreciation", type: "Check", defaultValue: false },
        ...
        { name: "is_fully_depreciated", label: "Is Fully Depreciated", type: "Check", defaultValue: false },
        {
